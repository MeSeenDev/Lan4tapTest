...
public class Response implements IResponse {
    ...
    public String toString() {
        return "Response{" +
                "\nmEcrNumber=" + mEcrNumber +
                "\n, mEcrMerchantNumber=" + mEcrMerchantNumber +
                "\n, mOperationCode=" + mOperationCode +
                "\n, mOriginalOperationCode=" + mOriginalOperationCode +
                "\n, mTotalAmount=" + mTotalAmount +
                "\n, mPartialAmount=" + mPartialAmount +
                "\n, mAcquirerFeeAmount=" + mAcquirerFeeAmount +
                "\n, mTerminalFeeAmount=" + mTerminalFeeAmount +
                "\n, mTipsAmount=" + mTipsAmount +
                "\n, mCurrencyCode=" + mCurrencyCode +
                "\n, mReceiptReference='" + mReceiptReference + '\'' +
                "\n, mRRN='" + mRRN + '\'' +
                "\n, mStatus=" + mStatus +
                "\n, mOriginalOperationStatus=" + mOriginalOperationStatus +
                "\n, mTransDateTime='" + mTransDateTime + '\'' +
                "\n, mTerminalDateTime='" + mTerminalDateTime + '\'' +
                "\n, mCardPAN='" + mCardPAN + '\'' +
                "\n, mExpireDate='" + mExpireDate + '\'' +
                "\n, mCardholderName='" + mCardholderName + '\'' +
                "\n, mCardholderAuthMethod=" + mCardholderAuthMethod +
                "\n, mAuthCode='" + mAuthCode + '\'' +
                "\n, mResponseCode='" + mResponseCode + '\'' +
                "\n, mResponseText='" + mResponseText + '\'' +
                "\n, mSTAN='" + mSTAN + '\'' +
                "\n, mTransactionID='" + mTransactionID + '\'' +
                "\n, mTerminalID='" + mTerminalID + '\'' +
                "\n, mCardEmvAid='" + mCardEmvAid + '\'' +
                "\n, mCardAppName='" + mCardAppName + '\'' +
                "\n, mCardInputMethod=" + mCardInputMethod +
                "\n, mIssuerName='" + mIssuerName + '\'' +
                "\n, mAdditionalInfo='" + mAdditionalInfo + '\'' +
                "\n, mCardData='" + mCardData + '\'' +
                "\n, mCardDataEnc='" + mCardDataEnc + '\'' +
                ...
                "\n, mCID='" + mCID + '\'' +
                "\n, mKVR='" + mKVR + '\'' +
                "\n, mCDAResult='" + mCDAResult + '\'' +
                "\n, mSalesCount=" + mSalesCount +
                "\n, mVoidCount=" + mVoidCount +
                "\n, mRefundCount=" + mRefundCount +
                "\n, mCardPANHash='" + mCardPANHash + '\'' +
                "\n, mReceiptLine1='" + mReceiptLine1 + '\'' +
                "\n, mReceiptLine2='" + mReceiptLine2 + '\'' +
                "\n, mReceiptLine3='" + mReceiptLine3 + '\'' +
                "\n, mReceiptLine4='" + mReceiptLine4 + '\'' +
                "\n, mReceiptLine5='" + mReceiptLine5 + '\'' +
                "\n, mFinalizationRequired=" + mFinalizationRequired +
                "\n, mApplicationLabel='" + mApplicationLabel + '\'' +
                "\n, mSalesArray=" + mSalesArray +
                "\n, mVoidArray=" + mVoidArray +
                "\n, mRefundArray=" + mRefundArray +
                "\n, mCurrentFields=" + mCurrentFields +
                "\n, mMandatoryFieldsList=" + mMandatoryFieldsList +
                "\n, mOptionalFieldsList=" + mOptionalFieldsList +
                '}';
    }
}
